...
var app = (function () {
    ...
    class Router extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$o, create_fragment$v, safe_not_equal, { basepath: 3, url: 4 });
    	}
    }
    ...
    class Route extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$n, create_fragment$u, safe_not_equal, { path: 8, component: 0 });
    	}
    }
    ...
    */
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(a2, "click", click_handler_1$2),
    					listen(a3, "click", click_handler_2$2),
    ...
    function create_fragment$s(ctx) {
        ...
        <input type="text" placeholder="Search here..." class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:ring w-full pl-10"/></div>`;
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(a, "click", click_handler$4);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    class NotificationDropdown extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$l, create_fragment$r, safe_not_equal, {});
    	}
    }
    ...
    function create_fragment$q(ctx) {
    	...
    	return {
    		c() {
    			...
    			a6.innerHTML = `<i class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"></i>
            Login`;
    			...
    			a7.innerHTML = `<i class="fas fa-clipboard-list text-blueGray-300 mr-2 text-sm"></i>
            Register`;
    			...
    			a8.innerHTML = `<i class="fas fa-newspaper text-blueGray-300 mr-2 text-sm"></i>
            Landing Page`;
    			...
    			a9.innerHTML = `<i class="fas fa-user-circle text-blueGray-300 mr-2 text-sm"></i>
            Profile Page`;
    			...
    			ul4.innerHTML = `<li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/svelte/colors/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fas fa-paint-brush mr-2 text-blueGray-300 text-base"></i>
            Styles</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/svelte/alerts/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-css3-alt mr-2 text-blueGray-300 text-base"></i>
            CSS Components</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/angular/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-angular mr-2 text-blueGray-300 text-base"></i>
            Angular</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/js/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-js-square mr-2 text-blueGray-300 text-base"></i>
            Javascript</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/nextjs/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-react mr-2 text-blueGray-300 text-base"></i>
            NextJS</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/react/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-react mr-2 text-blueGray-300 text-base"></i>
            React</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/svelte/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fas fa-link mr-2 text-blueGray-300 text-base"></i>
            Svelte</a></li> 

        <li class="inline-flex"><a href="https://www.creative-tim.com/learning-lab/tailwind/vue/overview/notus" target="_blank" class="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i class="fab fa-vuejs mr-2 text-blueGray-300 text-base"></i>
            VueJS</a></li>`;
    			...
    			attr(hr1, "class", "my-4 md:min-w-full");
    			attr(h61, "class", "md:min-w-full text-blueGray-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline");
    			attr(a6, "class", "text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block");
    			attr(a6, "href", "/auth/login");
    			attr(li6, "class", "items-center");
    			attr(a7, "class", "text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block");
    			attr(a7, "href", "/auth/register");
    			attr(li7, "class", "items-center");
    			attr(ul2, "class", "md:flex-col md:min-w-full flex flex-col list-none md:mb-4");
    			attr(hr2, "class", "my-4 md:min-w-full");
    			attr(h62, "class", "md:min-w-full text-blueGray-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline");
    			attr(a8, "class", "text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block");
    			attr(a8, "href", "/landing");
    			attr(li8, "class", "items-center");
    			attr(a9, "class", "text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block");
    			attr(a9, "href", "/profile");
    			attr(li9, "class", "items-center");
    			attr(ul3, "class", "md:flex-col md:min-w-full flex flex-col list-none md:mb-4");
    			attr(hr3, "class", "my-4 md:min-w-full");
    			attr(h63, "class", "md:min-w-full text-blueGray-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline");
    			attr(ul4, "class", "md:flex-col md:min-w-full flex flex-col list-none md:mb-4");
    ...
    class Sidebar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$k, create_fragment$q, safe_not_equal, { location: 0 });
    	}
    }
    ...
    function create_fragment$m(ctx) {
    	...
    	return {
    		c() {
    			...
    			div5.innerHTML = `<div class="rounded-t mb-0 px-4 py-3 bg-transparent"><div class="flex flex-wrap items-center"><div class="relative w-full max-w-full flex-grow flex-1"><h6 class="uppercase text-blueGray-100 mb-1 text-xs font-semibold">Overview</h6> 
        <h2 class="text-white text-xl font-semibold">Sales value</h2></div></div></div> 
  <div class="p-4 flex-auto"><div class="relative h-350-px"><canvas id="line-chart"></canvas></div></div>`;

    			attr(div5, "class", "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-blueGray-700");
    		},
    		m(target, anchor) {
    			insert(target, div5, anchor);
    		},
  ...
  <div class="block w-full overflow-x-auto"><table class="items-center w-full bg-transparent border-collapse"><thead class="thead-light"><tr><th class="px-6 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Referral</th> 
    ...
    class Dashboard extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$f, create_fragment$i, safe_not_equal, { location: 0 });
    	}
    }
  ...
  <div class="flex-auto px-4 lg:px-10 py-10 pt-0"><form><h6 class="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">User Information</h6> 
    ...
    class Settings extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$e, create_fragment$f, safe_not_equal, { location: 0 });
    	}
    }
    ...
    class CardTable extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$c, create_fragment$d, safe_not_equal, { color: 0 });
    	}
    }
    ...
    class Tables extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$b, create_fragment$c, safe_not_equal, { location: 0 });
    	}
    }
    ...
    class Maps extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$9, create_fragment$a, safe_not_equal, { location: 0 });
    	}
    }
    ...
    class Admin extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$8, create_fragment$9, safe_not_equal, { location: 0, admin: 1 });
    	}
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		c() {
    			...
    			ul.innerHTML = `<li class="flex items-center"><a class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold" href="https://twitter.com/_Growwmore" target="_blank"><i class="lg:text-blueGray-200 text-blueGray-400 fab fa-twitter text-lg leading-lg"></i> 
            <span class="lg:hidden inline-block ml-2">Tweet</span></a></li> 

        <li class="flex items-center"><a class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold" href="https://github.com/growwmore/growwmore.net" target="_blank"><i class="lg:text-blueGray-200 text-blueGray-400 fab fa-github text-lg leading-lg"></i> 
            <span class="lg:hidden inline-block ml-2">Star</span></a></li>`;

    			attr(ul, "class", "flex flex-col lg:flex-row list-none lg:ml-auto");
    			attr(div0, "class", div0_class_value = "lg:flex flex-grow items-center bg-white lg:bg-opacity-0 lg:shadow-none rounded shadow-lg " + (/*navbarOpen*/ ctx[0] ? "block" : "hidden"));
    			attr(div0, "id", "example-navbar-warning");
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*navbarOpen*/ 1 && div0_class_value !== (div0_class_value = "lg:flex flex-grow items-center bg-white lg:bg-opacity-0 lg:shadow-none rounded shadow-lg " + (/*navbarOpen*/ ctx[0] ? "block" : "hidden"))) {
    				attr(div0, "class", div0_class_value);
    			}
    		},
    		i: noop,
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = `GrowwMore © ${/*date*/ ctx[1]}`;
    			t2 = space();
    			div2 = element("div");
    			div2.innerHTML = `<ul class="flex flex-wrap list-none md:justify-end justify-center"><li class="flex items-center text-sm text-white font-semibold uppercase py-1 text-center md:text-left">Raj Chhaniyara &amp; Raj Patel</li></ul>`;
    			attr(div0, "class", "text-sm text-white font-semibold py-1 text-center md:text-left");
    			attr(div1, "class", "w-full md:w-4/12 px-4");
    			attr(div2, "class", "w-full md:w-8/12 px-4");
    			attr(div3, "class", "flex flex-wrap items-center md:justify-between justify-center");
    			attr(div4, "class", "container mx-auto px-4");
    			...
    			? "absolute w-full bottom-0 bg-green-200"
    			: "relative"));
    		},
    		m(target, anchor) {
    			insert(target, footer, anchor);
    ...
    class FooterSmall extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$6, create_fragment$7, safe_not_equal, { absolute: 0 });
    	}
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			h2 = element("h2");
    			h2.innerHTML = `GROWWMORE<sup>©</sup>`;
    			t3 = space();
    			h4 = element("h4");
    			h4.textContent = "Investing is for everyone. We're here to help you";
    			attr(img, "class", "relative top-0 b-auto center");
    			if (img.src !== (img_src_value = logo$1)) attr(img, "src", img_src_value);
    			attr(h2, "class", "font-semibold text-center text-4xl text-black");
    			set_style(h2, "font-family", "Matryoshka");
    			attr(h4, "class", "font-semibold text-center text-2xl text-white");
    			attr(div0, "class", "w-full md:w-6/12 mx-auto lg:w-6/12 xl:w-6/12 px-4");
    			attr(div1, "class", "container center mx-auto px-4 h-full");
    			attr(section, "class", "header relative pt-0 mt-25 max-h-860-px");
    		},
    		m(target, anchor) {
    ...
    const logo$1 = "../assets/img/gm_logo.svg";
    ...
    class Login extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$5, create_fragment$6, safe_not_equal, { location: 0 });
    	}
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "absolute top-0 w-full h-full bg-green-200 bg-no-repeat bg-full");
    			set_style(div0, "background-image", "url(" + registerBg2$1 + ")");
    ...
    const registerBg2$1 = "../assets/img/register_bg_1.png";
    ...
    class Auth extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$5, safe_not_equal, { location: 0, auth: 1 });
    	}
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(h2, "font-family", "Matryoshka");
    			attr(h4, "class", "font-semibold text-center text-2xl text-white");
    			attr(div1, "class", "w-full md:w-6/12 mx-auto lg:w-6/12 xl:w-6/12 px-4");
    			attr(div2, "class", "container center mx-auto px-4 h-full");
    			attr(section0, "class", "header relative pt-0 mt-25 max-h-860-px");
    			attr(section1, "class", "relative w-full h-full py-40 min-h-screen");
    		},
    		m(target, anchor) {
    			insert(target, div3, anchor);
    			mount_component(authnavbar, div3, null);
    			append(div3, t0);
    			append(div3, main);
    			...
    			append(div1, h4);
    			append(section1, t7);
    			mount_component(footersmall, section1, null);
    			current = true;
    		},
    		p: noop,
    		i(local) {
    ...
    const registerBg2 = "../assets/img/register_bg_1.png";

    // core components
    const logo = "/assets/img/gm_logo.svg";
    ...
    function create_fragment$2(ctx) {
      ...
      <div class="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden h-70-px" style="transform: translateZ(0);"><svg class="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0"><polygon class="text-blueGray-200 fill-current" points="2560 0 2560 100 0 100"></polygon></svg></div>`;
    			...
    			div19.innerHTML = `<div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center"><div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"><div class="px-4 py-5 flex-auto"><div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-red-400"><i class="fas fa-award"></i></div> 
                <h6 class="text-xl font-semibold">Awarded Agency</h6> 
                <p class="mt-2 mb-4 text-blueGray-500">Divide details about your product or agency work into parts. A
                  paragraph describing a feature will be enough.</p></div></div></div> 
          ...
          <div class="w-full md:w-4/12 px-4 text-center"><div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"><div class="px-4 py-5 flex-auto"><div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400"><i class="fas fa-retweet"></i></div> 
                ...
                <p class="mt-2 mb-4 text-blueGray-500">Keep you user engaged by providing meaningful information.
                  Remember that by this time, the user is curious.</p></div></div></div> 

          <div class="pt-6 w-full md:w-4/12 px-4 text-center"><div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"><div class="px-4 py-5 flex-auto"><div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-emerald-400"><i class="fas fa-fingerprint"></i></div> 
                <h6 class="text-xl font-semibold">Verified Company</h6> 
                <p class="mt-2 mb-4 text-blueGray-500">Write a few lines about each one. A paragraph describing a
                  feature will be enough. Keep you user engaged!</p></div></div></div>`;

    			t20 = space();
    			div24 = element("div");
    			div21 = element("div");
    			div20 = element("div");
    			div20.innerHTML = `<i class="fas fa-user-friends text-xl"></i>`;
    			t21 = space();
    			h30 = element("h3");
              ...
              <blockquote class="relative p-8 mb-4"><svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block h-95-px -top-94-px"><polygon points="-30,95 583,95 583,65" class="text-red-400 fill-current"></polygon></svg> 
                ...
                <p class="text-md font-light mt-2 text-white">The Arctic Ocean freezes every winter and much of the sea-ice
                  then thaws every summer, and that process will continue
                  whatever happens.</p></blockquote></div>`;

    			t35 = space();
    			section1 = element("section");

    			section1.innerHTML = `<div class="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20 h-20" style="transform: translateZ(0);"><svg class="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0"><polygon class="text-white fill-current" points="2560 0 2560 100 0 100"></polygon></svg></div> 

      <div class="container mx-auto px-4"><div class="items-center flex flex-wrap"><div class="w-full md:w-4/12 ml-auto mr-auto px-4"><img alt="..." class="max-w-full rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1555212697-194d092e3b8f?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=634&amp;q=80"/></div> 
          <div class="w-full md:w-5/12 ml-auto mr-auto px-4"><div class="md:pr-12"><div class="text-red-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-red-300"><i class="fas fa-rocket text-xl"></i></div> 
              <h3 class="text-3xl font-semibold">A growing company</h3> 
              <p class="mt-4 text-lg leading-relaxed text-blueGray-500">The extension comes with three pre-built pages to help you get
                started faster. You can change the text and images and you&#39;re
                good to go.</p> 
              <ul class="list-none mt-6"><li class="py-2"><div class="flex items-center"><div><span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-red-600 bg-red-200 mr-3"><i class="fas fa-fingerprint"></i></span></div> 
                    <div><h4 class="text-blueGray-500">Carefully crafted components</h4></div></div></li> 
                <li class="py-2"><div class="flex items-center"><div><span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-red-600 bg-red-200 mr-3"><i class="fab fa-html5"></i></span></div> 
                    <div><h4 class="text-blueGray-500">Amazing page examples</h4></div></div></li> 
                <li class="py-2"><div class="flex items-center"><div><span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-red-600 bg-red-200 mr-3"><i class="far fa-paper-plane"></i></span></div> 
                    <div><h4 class="text-blueGray-500">Dynamic components</h4></div></div></li></ul></div></div></div></div>`;
    			...
    			div43.innerHTML = `<div class="w-full lg:w-6/12 px-4"><h2 class="text-4xl font-semibold">Here are our heroes</h2> 
            <p class="text-lg leading-relaxed m-4 text-blueGray-500">According to the National Oceanic and Atmospheric Administration,
              ...
              maximum.</p></div>`;
                ...
                <div class="mt-6"><button class="bg-pink-500 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button"><i class="fab fa-dribbble"></i></button> 
                  <button class="bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button"><i class="fab fa-google"></i></button> 
                  <button class="bg-lightBlue-400 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button"><i class="fab fa-twitter"></i></button> 
                  <button class="bg-blueGray-700 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button"><i class="fab fa-instagram"></i></button></div>`;
      ...
      <div class="container mx-auto px-4 lg:pt-24 lg:pb-64"><div class="flex flex-wrap text-center justify-center"><div class="w-full lg:w-6/12 px-4"><h2 class="text-4xl font-semibold text-white">Build something</h2> 
            <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-400">Put the potentially record low maximum sea ice extent tihs year
              down to low ice. According to the National Oceanic and Atmospheric
              Administration, Ted, Scambos.</p></div></div> 
        <div class="flex flex-wrap mt-12 justify-center"><div class="w-full lg:w-3/12 px-4 text-center"><div class="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center"><i class="fas fa-medal text-xl"></i></div> 
          ...
          <div class="w-full lg:w-3/12 px-4 text-center"><div class="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center"><i class="fas fa-poll text-xl"></i></div> 
            <h5 class="text-xl mt-5 font-semibold text-white">Grow your market</h5> 
            <p class="mt-2 mb-4 text-blueGray-400">Some quick example text to build on the card title and make up the
              bulk of the card&#39;s content.</p></div> 
          <div class="w-full lg:w-3/12 px-4 text-center"><div class="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center"><i class="fas fa-lightbulb text-xl"></i></div> 
            ...
            <p class="mt-2 mb-4 text-blueGray-400">Some quick example text to build on the card title and make up the
              bulk of the card&#39;s content.</p></div></div></div>`;
                ...
                <div class="relative w-full mb-3 mt-8"><label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="full-name">Full Name</label> 
                  <input id="full-name" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Full Name"/></div> 

                <div class="relative w-full mb-3"><label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="email">Email</label> 
                  <input id="email" type="email" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Email"/></div> 

                <div class="relative w-full mb-3"><label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="message">Message</label> 
    			...
    			attr(div20, "class", "text-blueGray-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white");
    			attr(h30, "class", "text-3xl mb-2 font-semibold leading-normal");
    			attr(p4, "class", "text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600");
    			attr(p5, "class", "text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-600");
    			attr(a, "href", "/");
    			attr(a, "class", "font-bold text-blueGray-700 mt-8");
    			attr(div21, "class", "w-full md:w-5/12 px-4 mr-auto ml-auto");
    			attr(div23, "class", "w-full md:w-4/12 px-4 mr-auto ml-auto");
    			attr(div24, "class", "flex flex-wrap items-center mt-32");
    			...
    			attr(div59, "class", "w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4");
    			attr(div60, "class", "flex flex-wrap");
    			attr(div61, "class", "container mx-auto px-4");
    			attr(section2, "class", "pt-20 pb-48");
    			attr(section3, "class", "pb-20 relative block bg-blueGray-800");
    			attr(section4, "class", "relative block py-24 lg:pt-0 bg-blueGray-800");
    		},
    		m(target, anchor) {
    			insert(target, div82, anchor);
    			append(div82, main);
    			append(main, div6);
    			append(main, t5);
